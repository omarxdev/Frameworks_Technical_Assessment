...
const buttonVariants = cva(
 ...
 "h-8 gap-1.5 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
        ...
        touch: "h-touch gap-2 px-4 [&_svg:not([class*='size-'])]:size-4",
 "touch-lg":
 "h-touch-lg gap-2 px-4 text-base [&_svg:not([class*='size-'])]:size-5",
        icon: "size-8",
 "icon-touch": "size-touch [&_svg:not([class*='size-'])]:size-4",
 "icon-xs":
